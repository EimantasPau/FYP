       ...
       <v-container>
           <v-layout row wrap justify-center>
               <v-flex xs12 md10>
                   ...
                   <p>This Privacy Policy governs the manner in which Education Plus collects, uses, maintains and discloses information collected from users (each, a "User") of the http://learning.test website ("Site").</p>
                   ...
                   <p>Education Plus may collect and use Users personal information for the following purposes:</p>
                   <ul>
                       <li>
                   ...
                   <p>Education Plus has the discretion to update this privacy policy at any time. When we do, we will post a notification on the main page of our Site. We encourage Users to frequently check this page for any changes to stay informed about how we are helping to protect the personal information we collect. You acknowledge and agree that it is your responsibility to review this privacy policy periodically and become aware of modifications.</p>
                   ...
                   <p>This document was last updated on April 24, 2018</p>
               </v-flex>
           </v-layout>
       </v-container>
   </v-content>
