<template>
    <v-container px-0>
        <h2 class="display-1 grey--text text--darken-1"><v-btn fab small color="primary" router :to="'/account/courses/'+id+'/lessons'"><v-icon medium color="white">arrow_back</v-icon ></v-btn>Lessons <v-btn router :to="'/account/courses/' + id +'/lessons/create'" fab small color="light-blue accent-4"><v-icon medium color="white">add</v-icon ></v-btn></h2>
